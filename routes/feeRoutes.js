...
import { generateInvoicesForClass, getStudentStatement, recordPayment, reversePayment ,getFeeSummaryByClass} from "../controllers/feeController.js";
...
router.get("/summary-by-class", checkPermission("fees"), getFeeSummaryByClass);
